...
(function() {
  ...
  var products = [
    [
      [
        { name: 'Honor 10', price: '$1000', rating: 3.5 },
        { name: 'Samsung Note 10', price: '$2000', rating: 3.8 },
      ],
      [
        { name: 'HP i5 Core', price: '$3500', rating: 2.5 },
        { name: 'Microsoft Surface', price: '$6000', rating: 4.5 },
      ],
      [{ name: 'Asus 10x', price: '$1000', rating: 4.0 }],
    ],
    [
      [
        { name: 'Philps 48', price: '$6000', rating: 3.5 },
        { name: 'LG Smart', price: '$6500', rating: 3.5 },
      ],
      [{ name: 'LG', price: '$8500', rating: 4.0 }],
      [{ name: 'Samsung', price: '$2500', rating: 4.0 }],
    ],
    [
      [
        { name: 'Milton Lunch Box', price: '$200', rating: 4.6 },
        { name: 'Pegion Mop Set', price: '$500', rating: 4.8 },
      ],
      [{ name: 'Philis LED', price: '$85', rating: 3.4 }],
    ],
    [
      [{ name: 'Game 1', price: '$2000', rating: 2.3 }],
      [{ name: 'Toy Train D', price: '$50', rating: 4.0 }],
    ],
  ];
  ...
  vm.storeVM = function(route, param) {
    ...
    categories.forEach(function(item, index) {
      $('#categories').append(
        "<li><a href='#/categories/" + index + "'>" + item + '</a></li>'
      );
    });
  };
